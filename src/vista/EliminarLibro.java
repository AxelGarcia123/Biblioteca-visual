...
public class EliminarLibro extends JPanel implements ActionListener{
	...
	public EliminarLibro() {
		...
		datoAutor.setHorizontalAlignment(SwingConstants.CENTER);
		...
		datoEditorial.setHorizontalAlignment(SwingConstants.CENTER);
		...
		datoNoEdicion.setHorizontalAlignment(SwingConstants.CENTER);
		...
		datoAnioEdicion.setHorizontalAlignment(SwingConstants.CENTER);
		...
		datoIdioma.setHorizontalAlignment(SwingConstants.CENTER);
		...
		datoPaisOrigen.setHorizontalAlignment(SwingConstants.CENTER);
